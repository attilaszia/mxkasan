...
extern uint64_t mx_ticks_get(
void) __attribute__((__leaf__));

extern uint64_t _mx_ticks_get(
void) __attribute__((__leaf__));

extern uint64_t mx_ticks_per_second(
void) __attribute__((__leaf__)) __attribute__((const));

extern uint64_t _mx_ticks_per_second(
void) __attribute__((__leaf__)) __attribute__((const));

extern mx_time_t mx_deadline_after(
mx_duration_t nanoseconds) __attribute__((__leaf__));

extern mx_time_t _mx_deadline_after(
mx_duration_t nanoseconds) __attribute__((__leaf__));

extern uint32_t mx_system_get_num_cpus(
void) __attribute__((__leaf__)) __attribute__((const));

extern uint32_t _mx_system_get_num_cpus(
void) __attribute__((__leaf__)) __attribute__((const));

extern mx_status_t mx_system_get_version(
char* version,
    uint32_t version_len) __attribute__((__leaf__));

extern mx_status_t _mx_system_get_version(
char* version,
    uint32_t version_len) __attribute__((__leaf__));

extern uint64_t mx_system_get_physmem(
void) __attribute__((__leaf__));

extern uint64_t _mx_system_get_physmem(
void) __attribute__((__leaf__));
...
extern mx_status_t mx_object_set_cookie(
mx_handle_t handle,
    mx_handle_t scope,
    uint64_t cookie) __attribute__((__leaf__));

extern mx_status_t _mx_object_set_cookie(
mx_handle_t handle,
    mx_handle_t scope,
    uint64_t cookie) __attribute__((__leaf__));

extern mx_status_t mx_object_get_cookie(
mx_handle_t handle,
    mx_handle_t scope,
    uint64_t* cookie) __attribute__((__leaf__));

extern mx_status_t _mx_object_get_cookie(
mx_handle_t handle,
    mx_handle_t scope,
    uint64_t* cookie) __attribute__((__leaf__));
...
extern mx_status_t mx_job_set_policy(
mx_handle_t job,
    uint32_t options,
    uint32_t topic,
    const void* policy,
...
extern mx_status_t _mx_job_set_policy(
mx_handle_t job,
    uint32_t options,
    uint32_t topic,
    const void* policy,
...
extern mx_status_t mx_task_suspend(
mx_handle_t task_handle) __attribute__((__leaf__));

extern mx_status_t _mx_task_suspend(
mx_handle_t task_handle) __attribute__((__leaf__));
...
extern mx_status_t mx_port_cancel(
mx_handle_t handle,
    mx_handle_t source,
    uint64_t key) __attribute__((__leaf__));

extern mx_status_t _mx_port_cancel(
mx_handle_t handle,
    mx_handle_t source,
    uint64_t key) __attribute__((__leaf__));

extern mx_status_t mx_timer_create(
uint32_t options,
    uint32_t clock_id,
    mx_handle_t* out) __attribute__((__leaf__));

extern mx_status_t _mx_timer_create(
uint32_t options,
    uint32_t clock_id,
    mx_handle_t* out) __attribute__((__leaf__));

extern mx_status_t mx_timer_start(
mx_handle_t handle,
    mx_time_t deadline,
    mx_duration_t period,
    mx_duration_t slack) __attribute__((__leaf__));

extern mx_status_t _mx_timer_start(
mx_handle_t handle,
    mx_time_t deadline,
    mx_duration_t period,
    mx_duration_t slack) __attribute__((__leaf__));

extern mx_status_t mx_timer_cancel(
mx_handle_t handle) __attribute__((__leaf__));

extern mx_status_t _mx_timer_cancel(
mx_handle_t handle) __attribute__((__leaf__));
...
extern mx_status_t mx_vmo_clone(
mx_handle_t handle,
    uint32_t options,
    uint64_t offset,
    uint64_t size,
...
extern mx_status_t _mx_vmo_clone(
mx_handle_t handle,
    uint32_t options,
    uint64_t offset,
    uint64_t size,
...
extern mx_status_t mx_vmo_set_cache_policy(
mx_handle_t handle,
    uint32_t cache_policy) __attribute__((__leaf__));

extern mx_status_t _mx_vmo_set_cache_policy(
mx_handle_t handle,
    uint32_t cache_policy) __attribute__((__leaf__));
...
extern void mx_futex_wake_handle_close_thread_exit(
const mx_futex_t* value_ptr,
    uint32_t count,
    int new_value,
    mx_handle_t handle) __attribute__((__leaf__)) __attribute__((__noreturn__));

extern void _mx_futex_wake_handle_close_thread_exit(
const mx_futex_t* value_ptr,
    uint32_t count,
    int new_value,
    mx_handle_t handle) __attribute__((__leaf__)) __attribute__((__noreturn__));
...
extern mx_status_t mx_set_framebuffer_vmo(
mx_handle_t handle,
    mx_handle_t vmo,
    uint32_t len,
    uint32_t format,
...
extern mx_status_t _mx_set_framebuffer_vmo(
mx_handle_t handle,
    mx_handle_t vmo,
    uint32_t len,
    uint32_t format,
...
extern mx_status_t mx_pci_get_config(
mx_handle_t handle,
    mx_pci_resource_t* out_config) __attribute__((__leaf__));

extern mx_status_t _mx_pci_get_config(
mx_handle_t handle,
    mx_pci_resource_t* out_config) __attribute__((__leaf__));
...
extern mx_status_t mx_pci_map_interrupt(
mx_handle_t handle,
    int32_t which_irq,
    mx_handle_t* out_handle) __attribute__((__leaf__));

extern mx_status_t _mx_pci_map_interrupt(
mx_handle_t handle,
    int32_t which_irq,
    mx_handle_t* out_handle) __attribute__((__leaf__));
...
extern uint64_t mx_acpi_uefi_rsdp(
mx_handle_t handle) __attribute__((__leaf__));

extern uint64_t _mx_acpi_uefi_rsdp(
mx_handle_t handle) __attribute__((__leaf__));
...
extern mx_status_t mx_resource_destroy(
mx_handle_t handle) __attribute__((__leaf__));

extern mx_status_t _mx_resource_destroy(
mx_handle_t handle) __attribute__((__leaf__));
...
extern mx_status_t mx_hypervisor_op(
mx_handle_t handle,
    uint32_t opcode,
    const void* args,
    uint32_t args_len,
...
extern mx_status_t _mx_hypervisor_op(
mx_handle_t handle,
    uint32_t opcode,
    const void* args,
    uint32_t args_len,
...
extern mx_status_t mx_system_mexec(
mx_handle_t kernel,
    mx_handle_t bootimage) __attribute__((__leaf__));

extern mx_status_t _mx_system_mexec(
mx_handle_t kernel,
    mx_handle_t bootimage) __attribute__((__leaf__));

extern mx_status_t mx_syscall_test_0(
void) __attribute__((__leaf__));

extern mx_status_t _mx_syscall_test_0(
void) __attribute__((__leaf__));

extern mx_status_t mx_syscall_test_1(
int a) __attribute__((__leaf__));

extern mx_status_t _mx_syscall_test_1(
int a) __attribute__((__leaf__));

extern mx_status_t mx_syscall_test_2(
int a,
    int b) __attribute__((__leaf__));

extern mx_status_t _mx_syscall_test_2(
int a,
    int b) __attribute__((__leaf__));

extern mx_status_t mx_syscall_test_3(
int a,
    int b,
    int c) __attribute__((__leaf__));

extern mx_status_t _mx_syscall_test_3(
int a,
    int b,
    int c) __attribute__((__leaf__));

extern mx_status_t mx_syscall_test_4(
int a,
    int b,
    int c,
    int d) __attribute__((__leaf__));

extern mx_status_t _mx_syscall_test_4(
int a,
    int b,
    int c,
    int d) __attribute__((__leaf__));

extern mx_status_t mx_syscall_test_5(
int a,
    int b,
    int c,
    int d,
...
extern mx_status_t _mx_syscall_test_5(
int a,
    int b,
    int c,
    int d,
...
extern mx_status_t mx_syscall_test_6(
int a,
    int b,
    int c,
    int d,
...
extern mx_status_t _mx_syscall_test_6(
int a,
    int b,
    int c,
    int d,
...
extern mx_status_t mx_syscall_test_7(
int a,
    int b,
    int c,
    int d,
...
extern mx_status_t _mx_syscall_test_7(
int a,
    int b,
    int c,
    int d,
...
extern mx_status_t mx_syscall_test_8(
int a,
    int b,
    int c,
    int d,
...
extern mx_status_t _mx_syscall_test_8(
int a,
    int b,
    int c,
    int d,
...
extern mx_status_t mx_syscall_test_wrapper(
int a,
    int b,
    int c) __attribute__((__leaf__));

extern mx_status_t _mx_syscall_test_wrapper(
int a,
    int b,
    int c) __attribute__((__leaf__));
